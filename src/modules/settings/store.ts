...
export type Preferences = {
  ...
  vimMode: boolean;
  editorDiagnosticsEnabled: boolean;
  showHidden: boolean;
...
const KEY_EDITOR_DIAGNOSTICS_ENABLED = "editorDiagnosticsEnabled";
...
export async function loadPreferences(): Promise<Preferences> {
  ...
  return {
    ...
    editorDiagnosticsEnabled:
      get<boolean>(KEY_EDITOR_DIAGNOSTICS_ENABLED) ??
      DEFAULT_PREFERENCES.editorDiagnosticsEnabled,
    showHidden:
...
export async function setEditorDiagnosticsEnabled(value: boolean): Promise<void> {
  await writePref(KEY_EDITOR_DIAGNOSTICS_ENABLED, value);
}
...
export async function onPreferencesChange(
  ...
  const map: Record<string, PrefKey> = {
    ...
    [KEY_EDITOR_DIAGNOSTICS_ENABLED]: "editorDiagnosticsEnabled",
